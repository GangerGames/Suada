...
opts.Add(EnumVariable('platform', "Compilation platform",
         '', ['', 'javascript', 'windows', 'x11', 'linux', 'osx']))
...
if env['platform'] == 'javascript':
    env['CC'] = '/Users/feserr/apps/emsdk/upstream/emscripten/em'
    env['CXX'] = '/Users/feserr/apps/emsdk/upstream/emscripten/em++'
